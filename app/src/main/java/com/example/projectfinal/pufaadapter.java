...
public class pufaadapter extends FirebaseRecyclerAdapter<Data, pufaadapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public pufaadapter(@NonNull FirebaseRecyclerOptions<Data> options) {
        super(options);
    }
...
//                dialogPlus.show();
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("pufa")
