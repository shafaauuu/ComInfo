...
public class LecturerisAdapter extends FirebaseRecyclerAdapter<Datalecturer, LecturerisAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public LecturerisAdapter(@NonNull FirebaseRecyclerOptions<Datalecturer> options) {
        super(options);
    }
...
//                dialogPlus.show();
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Lecturer_is")
