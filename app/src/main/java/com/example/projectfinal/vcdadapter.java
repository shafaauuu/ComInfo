...
public class vcdadapter extends FirebaseRecyclerAdapter<Data, vcdadapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public vcdadapter(@NonNull FirebaseRecyclerOptions<Data> options) {
        super(options);
    }
...
//                dialogPlus.show();
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("puma vcd")
