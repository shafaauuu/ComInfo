...
public class IsAdapter extends FirebaseRecyclerAdapter<Data, IsAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public IsAdapter (@NonNull FirebaseRecyclerOptions<Data> options) {
        super(options);
    }
...
//                dialogPlus.show();
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("puma is")
