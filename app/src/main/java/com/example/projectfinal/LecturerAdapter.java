...
public class LecturerAdapter extends FirebaseRecyclerAdapter<Datalecturer, LecturerAdapter.myViewHolder> {
    /**
     ...
     * @param options
     */
    public LecturerAdapter(@NonNull FirebaseRecyclerOptions<Datalecturer> options) {
        super(options);
    }
...
//                dialogPlus.show();
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Lecturer_it")
